                ...
                <div className='mt-8'>
                    <div className='mt-8 flex flex-col gap-y-4'>
                        <ul>
                            ...
                            <li className='flex rounded-xl py-2 border-2 item-center justify-center gap-2 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all text-base'>                        <FaFacebookSquare className='mt-1 ml-4 ' /><button >Sign in with facebook</button>
